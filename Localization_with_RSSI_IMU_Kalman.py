...
def kalman_filter(measured_pos, position, speed, variance, earth_acc):
    ...
    os.system("echo " + str(pos_S) + "," + str(pos_E) + " >> Log_files/walk_from_kalman_filter_after_tune_3.csv")
...
# os.system("rm Log_files/stat_from_kalman_filter_after_tune_3.csv")

start_time = time.time()
with open('gen_data/walk_gen_data_com_3_edited.csv') as csv_file:
