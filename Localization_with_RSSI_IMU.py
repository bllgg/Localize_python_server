...
def localization_with_rssi(json_data):
    ...
    acc_ary = [json_data["acc_x"], json_data["acc_y"], json_data["acc_z"]]
    gyr_ary = [json_data["gyr_x"], json_data["gyr_y"], json_data["gyr_z"]]
    mag_ary = [json_data["mag_x"], json_data["mag_y"], json_data["mag_z"]]
    earth_acc = []
